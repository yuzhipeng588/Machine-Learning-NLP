...
pinitial_test=pd.read_csv('pgpub_claims_fulltext.csv',delimiter=',',nrows=3000,skiprows=range(1,30000),encoding='utf-8')
pfinal_test=pd.read_csv('patent_claims_fulltext.csv',delimiter=',',nrows=3000,skiprows=range(1,30000),encoding='utf-8')
